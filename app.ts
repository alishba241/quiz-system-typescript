...
const quiz: {
  ...
  },
  {
    ...
    type: "list",
    message: chalk.magentaBright(
      "Q2. Which of the following characters is commonly allowed in variable name in typescript?"
    ),
    choices: ["$", "@", "#", "&"],
  },
  {
    ...
    type: "list",
    message: chalk.magentaBright(
      "Q3. Which operator is commonly used for string concatination in typescript?"
    ),
    choices: ["+", "-", "*", "/"],
  },
  {
  ...
  },
  {
    ...
    type: "list",
    message: chalk.magentaBright(
      "Q5. Which method of inquirer.js is used to start the prompt interface and recieve user input?"
    ),
